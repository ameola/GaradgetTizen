...
#define DEF_STARTUP_VIEW_NAME "main"
...
static void (*uib_main_config_delegate_portrait)();
static void (*uib_main_config_delegate_landscape)();

static void (*uib_viewConfig_config_delegate_portrait)();
static void (*uib_viewConfig_config_delegate_landscape)();

char* g_main_config_name_portrait = NULL;
char* g_main_config_name_landscape = NULL;
char* g_viewConfig_config_name_portrait = NULL;
char* g_viewConfig_config_name_landscape = NULL;
...
void uib_views_init() {
	if(!gst_uib_views.is_init) {
		...
		case e_resolution_CIRCLE_360x360:
			uib_main_config_delegate_portrait = &uib_main_config_CIRCLE_360x360_portrait;
			g_main_config_name_portrait = "common";
			uib_main_config_delegate_landscape = &uib_main_config_CIRCLE_360x360_portrait;
			g_main_config_name_landscape = "common";

			uib_viewConfig_config_delegate_portrait = &uib_viewConfig_config_CIRCLE_360x360_portrait;
			g_viewConfig_config_name_portrait = "common";
			uib_viewConfig_config_delegate_landscape = &uib_viewConfig_config_CIRCLE_360x360_portrait;
			g_viewConfig_config_name_landscape = "common";
...
void set_targeted_view(uib_view_context* vc) {
	...
	if(gi_cur_user_view_idx < 0) {
		if(!strcmp(view_name,"main")) {
			gst_uib_views.uib_view_target_config_portrait = uib_main_config_delegate_portrait;
			gst_uib_views.uib_view_target_config_landscape = uib_main_config_delegate_landscape;

			g_views_config_delegate_name_portrait = g_main_config_name_portrait;
			g_views_config_delegate_name_landscape = g_main_config_name_landscape;

			uib_util_rotation_set(g_win_obj->win, e_rotation_default);
		} else if(!strcmp(view_name,"viewConfig")) {
			gst_uib_views.uib_view_target_config_portrait = uib_viewConfig_config_delegate_portrait;
			gst_uib_views.uib_view_target_config_landscape = uib_viewConfig_config_delegate_landscape;

			g_views_config_delegate_name_portrait = g_viewConfig_config_name_portrait;
			g_views_config_delegate_name_landscape = g_viewConfig_config_name_landscape;
